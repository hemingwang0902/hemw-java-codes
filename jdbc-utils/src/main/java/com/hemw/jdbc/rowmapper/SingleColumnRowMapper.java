...
import com.hemw.jdbc.utils.NumberUtils;
...
public class SingleColumnRowMapper<T> implements RowMapper<T> {
	...
	public T mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		if (nrOfColumns != 1) {
			throw new IncorrectResultSizeDataAccessException(1, nrOfColumns);
		}
	 ...
	 * @see com.hemw.jdbc.utils.springframework.jdbc.support.JdbcUtils#getResultSetValue(java.sql.ResultSet, int, Class)
	 ...
	 * @return the Object value
	 * @throws SQLException in case of extraction failure
	 * @see com.hemw.jdbc.utils.springframework.jdbc.support.JdbcUtils#getResultSetValue(java.sql.ResultSet, int)
	 */
